...
<audio src="../audio/lesson 3 summary.mp3"
 autoplay>
...
<div class="lesson1-mainbody"> <!-- The lessons icons like lesson1 . . . begins here  -->
	...
	<h2>Flowchart Symbols</h2>
		<p class="program-intro"> Flowchart symbols are categorized into two namely; basic flowchart and system flowchart symbols </p>
...
<p class="program-intro">
	Basic flowchart symbols are: terminal, processing box, input/output, decision box, flow lines, connector, and so on
...
<p class="program-intro">
system flowchart symbols include; printed output, punched card, disk, keyboard, VDU, off-line, manual operation, and so on.	
